...
async def _internal_transfer_to_telegram(
    ...
    progress_callback_args: tuple, progress_callback_kwargs: dict
...
async def download_file(
    ...
    async for x in downloaded:
        ...
        try:
            if progress_callback:
                await progress_callback(out.tell(), size, *progress_callback_args, **progress_callback_kwargs)
        except:
            pass
...
async def upload_file(
    ...
    global filename
    filename = name
    return (await _internal_transfer_to_telegram(client, file, progress_callback, progress_callback_args, progress_callback_kwargs))[0]